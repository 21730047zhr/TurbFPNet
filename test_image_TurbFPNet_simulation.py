...
parser.add_argument('--model_name', default='./model/TurbFPNet_simulation.pth', type=str, help='generator model epoch name')
parser.add_argument('--image_path', default='./simulated_data/lr/', type=str, help='generator model epoch name')
parser.add_argument('--image_name', default='baby', type=str, help='generator model epoch name')
